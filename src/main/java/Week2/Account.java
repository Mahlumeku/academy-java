...
public class Account {
    ...
    //equals method that checks if two account objects are equal
    @Override
    public boolean equals(Object obj){
        //check if the object is reference to the same instance
        if(this == obj) return true;
              
        //check if the object is an instance of account
