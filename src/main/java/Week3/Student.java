...
class Student {
	...
	public void editStudent(List<Student> universityStudents, Student student) {
		for (Student currentStudent : universityStudents) {
			...
			if (currentStudent.getStudentId() == updatedStudent.getStudentId()) {
				...
				currentStudent.setGender(updatedStudent.getGender());
				currentStudent.setBirthdate(updatedStudent.getBirthdate());
				currentStudent.setAdmissionDate(updatedStudent.getAdmissionDate());
				currentStudent.setCurriculumName(updatedStudent.getCurriculumName());
	...
	// I will say yes because it is a method which prints out the students infor and
	// it is possible
	// to define it in like this and we can call the method in the Main.Java class
